...
const AddExpenseModal: React.FC<AddExpenseModalProps> = ({ showExpenseModal, setExpenseShowModal }) => {
    ...
    return (
        <div>
            ...
            <button
                onClick={() => setExpenseShowModal(true)}
            ...
            {showExpenseModal && (
                <div className="fixed z-50 inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-lg p-6 relative">
                        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Add New Expense</h2>
